 ...
 *   ⑥ hcc-org SKILL.md §6 含 hcc-product-requirement §2 联动锚点（类型集单源真理）
...
// ── ⑥ hcc-org SKILL.md §6 含 hcc-product-requirement §2 联动锚点（单源真理）──
test('⑥ hcc-org §6 含 hcc-product-requirement §2 联动锚点 + 伪问题标注', () => {
  assert.ok(skillMd.includes('§6 产出项目部署契约'), 'SKILL.md 有 §6 段（部署契约落地）');
  assert.ok(skillMd.includes('hcc-product-requirement §2'), '§6 含 hcc-product-requirement §2 联动锚点（类型集单源，不另造档位）');
