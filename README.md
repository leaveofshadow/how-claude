...
| `cc-orchestration` | 编排决策（subagent / workflow / team 决策树 + Workflow opt-in `ultracode`/`fan out`）|
...
> ultracode 帮我并行深挖这几个方案    → cc-orchestration（Workflow opt-in：fan out subagents）
